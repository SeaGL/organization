...
Lavalier mics were nice, but some people still prefer regular mic, nice to be able to pass one aroundRoom bags should be labeled so we know if one has eq that needs to be repairedRoom bags should be labeled so we know if one has eq that needs to be repairedRoom bags should be labeled so we know if one has eq that needs to be repairedRoom bags should be labeled so we know if one has eq that needs to be repairedRoom bags should be labeled so we know if one has eq that needs to be repairedRoom bags should be labeled so we know if one has eq that needs to be repaired
...
Good idea
Bad idea
It gives us more freedom to be in charge of our own destiny.
Insofar as I know, the FSF has been pretty responsive to us in exchange for running a table, which I thought was a fair swap.


Would need board, by-laws, and tax help
It will be easier to fundraise if we tell people to donate to us than to the FSF.
Last time I looked, the IRS charged $800 to get the paperwork done.
There are rules that you have to be “in business” for a certain period of time.  We might pass that test already.
