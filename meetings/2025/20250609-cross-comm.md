...
#### Policy & Protocol
- updated h&s to enable speakers to ask that their rooms be mask required
  - Salt had a conversation with Dawn at PyCon US about the lack of speakers requesting this
  - decided to go with per-speaker rather than having an entire masked room
  - can tighten the policy if we get more interest or other things change in the world
