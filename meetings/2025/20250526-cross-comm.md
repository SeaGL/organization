...
- [ ] review communication channels document (everyone)
  ...
  - lets get this into a collective rather and call it done
...
#### 05/12
- [ ] update health and safety policy for 2025 (Salt)
- [ ] send out email to all past speakers reminding them of the CfP (Dina)
- [ ] add announcements email to the announcements channel in Matrix (Salt)
