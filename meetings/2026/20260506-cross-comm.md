...
- Wednesday, May 6, 2026. 6pm Pacific Time (2026-05-07 01:00 UTC)
...
## Procedural
### Check-in round
- Attendees: salt, dina, matt, sen, sergio
...
-->
- [2026 Vikunja Project](https://vikunja.seagl.org/projects/31)
...
#### AV
- coming back to this post lfnw
- more difficult to work on big files across state lines
- two more videos fixed and ready

#### DevOps
- had meeting!
- discussion about making sure our stuff was updated for copy.fail
- andrew exploring osem spindown
...
#### Programming & Flow
- working to get keynote voting poll out asap

#### Promotion & Outreach
- sen has been reaching out to podcasts to plug cfp, late night linux mentioned
- met and discused different ad styles, how to be provocative
- sergio posting drafts in matrix channel

#### Volunteers
- volunteers are very flaky
- devops and promo/outreach have upcoming volunteer work
- so far no pre-conference volunteers
- can promo/outreach help recruiting
...
#### lfnw retro
- sen attended
- interested in moving away from proprietary infra
- interested in doing more collaboration with seagl


### Open discussion (~5 minute, if time)

- sen to run meeting next week


## Wrap-up

### 05/06 - New TODOs
- [ ] distribute cfp fliers around city
  - spreadsheet to identify locations and track where fliers are: https://cloud.seagl.org/index.php/f/104422
  - would be nice to know where our posters were seen
    - could have unique hashtag for each qr-code/url
...
- Wednesday, May 13 @ 6pm Pacific Time (2026-05-14 01:00 UTC)

### Committee Meetings
- Attendee Experience: 
- AV: 
- DevOps: Mondays @ 5pm Pacific Time (Tuesdays @ 00:00 UTC)
- Finance: 
- IDEA: 
