...
- Monday, September 19, 2023. 4pm Pacific Time (2023-09-20 02:00 UTC)
...
- [ ] find someone to own running TeaGL (??)
  - up to the event operator how big it is, but someone needs to at least make sure we have HOT WATER
...
#### 09/08
- [ ] add task status indicator to discussion mechanisms section (Salt)
...
- [ ] schedule attendee experience meet with Tech, Dawn, and Salt (aj)
  - https://pad.seattlematrix.org/p/SeaGL_2023_experience
  - https://whenisgood.net/seagl-2023-ax-2
- [ ] fill out poll to decide on best weekly meeting time through November (everyone)
...
- [ ] fill out attendee XP time survey if you can help with the committee (everyone)
  - https://whenisgood.net/seagl-2023-ax-2
- [ ] send out scheduling poll for in-person working session week of 18th (Salt)
