...
- Monday, July 1st, 2024. 5pm Pacific Time (2024-07-02 01:00 UTC)
...
## Procedural
### Check-in round
- Attendees: Salt, Robin, Norm, AJ, Kim, Sean, Alfredo
- Apologies: 
- Facilitator: 
- Note Taker(s): 
...
#### Partnerships
- Bulk emails went out to sponsors.
  - Most reponded as Media Sponsors or Non-profits
  - Possible monetary sponsor forthcoming.

#### Policy & Protocol
- no updates

#### Programming & Flow
- 26 cfp submission 6/30
- cfp extended to 7/14
- Duane interested on Keynoting has to confirm with his employer

#### Promotion & Outreach
- Posted about cfp extension
- [ ] blog post about cfp extension is pending
- updated cfp info with new deadline

#### Volunteers
- new volunteer sean, interested to help with docs pipeline
  - AJ explaining our flow and cloudnext: cloud.seagl.org
...
- Monday, July 15 @ 5pm Pacific Time (2024-07-16 01:00 UTC)
