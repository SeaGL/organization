...
- Monday, April 8, 2024. 5pm Pacific Time (2024-04-09 01:00 UTC)
...
#### 02/26
- [ ] set up Pretalx (AJ)
- [ ] post call for volunteers (alfredo)
...
#### 03/25
- [ ] add links to status pages (AJ)
- [ ] add finance meeting to 2024 calendar (norm)
- [ ] verify lfnw knows that we are planning on tabling (salt)
- [ ] identify lfnw magic 8 ball boxes (salt)
- [ ] create 2024 sponsor form (salt)
  - https://cloud.seagl.org/index.php/apps/forms/s/wBLpnamkdjn2kMzDWaKeRSZ4
- [ ] send osi sponsor pipeline instruction to robin (norm)
...
- Monday, April 22 @ 5pm Pacific Time (2024-04-23 01:00 UTC)
