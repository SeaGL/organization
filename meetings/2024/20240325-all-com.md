...
- Monday, March 25, 2024. 5pm Pacific Time (2024-03-26 01:00 UTC)
...
#### 02/26
- [ ] set up Pretalx (AJ)
- [ ] set up regular programming & flow meetings (Dawn)
- [ ] post call for volunteers first week of march (alfredo)
- [ ] redesign /meet page to be main point of contact for getting onto matrix (andrew)
- [ ] create issue to collect 2024 speaker gift suggestions (Salt)

#### 03/11
- [ ] send keynote nomination form to staff (Dawn)
- [ ] talk to outreach about pushing form to socials (Dawn)
- [ ] fill out keynote nomination form (everyone)
- [ ] get Dawn access to pretalx trial (Salt)
- [ ] make decision about using pretalx (Dawn)
- [ ] work with mateus to get handbill out for SCaLE (Salt)
...
- Monday, April 8 @ 5pm Pacific Time (2024-04-09 01:00 UTC)
