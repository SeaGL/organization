...
# SeaGL 2024 Kick-Off
- Monday, January 29, 2024. 5pm Pacific Time (2024-01-30 01:00 UTC)
- [Shared Pad](https://pad.riseup.net/p/SeaGL_2024_kick-off)
- [Jitsi URL](https://meet.seattlematrix.org/SeaGL_2024_organizing)
...
- is there any reason to try to do multiple meeting times this year?
- when do we want to move to weekly meetings?

#### Communication Channels
- is everyone on Matrix, Mailinglist, GitHub, and NextCloud?
- does anyone who needs an @seagl.org email not have one?
- any suggestions for improving communication this year?

#### Committees
- do these committees still feel right?
- do we want to split a/v off from tech?
...
#### 2024 Venue
- how long do we want rooms?
- do we want the lounge area?
- do we want any different form-factor rooms?

#### Writing/sending thank-yous
...
- Monday, February 12 @ 5pm Pacific Time (2024-02-13 01:00 UTC)
